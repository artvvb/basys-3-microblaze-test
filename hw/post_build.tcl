...
puts "INFO: Running [info script] as write_bitstream tcl.post"
...
set top_module [get_property top [get_filesets sources_1]]
set handoff_dir [file join ${script_dir} hw_handoff]
set base_repo_dir [file dirname [file dirname ${script_dir}]]
set platform_src_dir [file join $base_repo_dir sw src platform]
set platform_xsa [file join ${platform_src_dir} ${top_module}.xsa]
file copy -force ${xsa_file} 
puts "INFO: Wrote out xsa file ${platform_xsa}"
